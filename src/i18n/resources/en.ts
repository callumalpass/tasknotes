...
export const en: TranslationTree = {
	...
	settings: {
		...
		keyboardShortcuts: {
			...
			captureHint: "Click, then press the desired key combination",
			recording: "Press keys…",
			confirmTitle: "Add shortcut?",
			confirmMessage: "Add {shortcut} to {action}?",
			confirm: "Add",
			...
			actions: {
				...
				"clear-focus-and-selection": "Clear focus and selection",
				"toggle-select": "Toggle focused task selection",
				"select-all": "Select all visible tasks",
				"copy-task-titles": "Copy task titles",
