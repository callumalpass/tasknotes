...
export const en: TranslationTree = {
	...
	modals: {
		...
		task: {
			...
			titleLabel: "Title",
			titleDetailedPlaceholder: "Title",
			...
			dependencies: {
				...
				addBlockedByButton: "Add blocked by",
				addBlockingButton: "Add blocking",
			...
			detailsShowLess: "Show less",
			chips: {
				timeEstimate: "Time estimate",
				timeEstimateValue: "{minutes} min",
				contextsPlural: "{count} contexts",
				tagsPlural: "{count} tags",
				tagSelected: "✓ {tag}",
				remindersSingle: "1 reminder",
				remindersPlural: "{count} reminders",
			},
			chipList: {
