...
export const zh: TranslationTree = {
	...
	views: {
		agenda: {
			...
			empty: {
				...
				noItemsFound: "未找到项目",
				helpText: "创建具有截止日期或开始日期的任务，或添加笔记以在此处显示它们。",
			},
			contextMenu: {
		...
		header: {
			...
			documentationUrl: "https://tasknotes.dev",
				...
				layout: {
					...
					spanScheduledToDue: "在开始日期和截止日期之间扩展任务",
				},
				propertyBasedEvents: {
		...
		pomodoro: {
			...
			status: {
				...
				shortBreak: "小憩",
				longBreak: "休整",
				breakPrompt: "做得很好！是时候{length}一下了",
				breakLength: {
					short: "小憩",
					long: "休整",
				},
	...
	settings: {
		...
		features: {
			...
			nlp: {
				...
				enable: {
					name: "启用自然语言任务输入",
					description: "创建任务时从自然语言解析到期日期、优先级和场景",
				},
				defaultToScheduled: {
					name: "默认为已安排",
					description: "当NLP检测到无场景的日期时，将其视为已安排而不是到期",
				},
				language: {
					name: "NLP语言",
			...
			pomodoro: {
				...
				shortBreak: {
					name: "小憩时长",
					description: "小憩的持续时间（分钟）",
				},
				longBreak: {
					name: "休整时长",
					description: "休整的持续时间（分钟）",
				},
				longBreakInterval: {
					name: "休整间隔",
					description: "休整前的工作会话数",
				},
				autoStartBreaks: {
					name: "自动开始休息",
			...
			recurring: {
				...
				maintainOffsetDesc: "重复任务完成时保持到期日期和开始日期之间的偏移",
				resetCheckboxesName: "重复时重置复选框",
				resetCheckboxesDesc: "当重复任务完成并重新安排时，重置任务正文中的所有markdown复选框",
			},
			timeblocking: {
				header: "时间块",
				description: "配置时间块功能，在日记中进行轻量级调度。在日历视图上拖动以创建事件 - 从场景菜单中选择'时间块'。",
				enableName: "启用时间块",
				enableDesc: "启用时间块功能，在日记中进行轻量级调度。启用后，'时间块'选项会出现在日历拖动场景菜单中。",
				showBlocksName: "显示时间块",
				showBlocksDesc: "默认显示日记中的时间块",
				defaultColorName: "默认时间块颜色",
				defaultColorDesc: "创建新时间块时使用的默认颜色",
				usage: "用法：在日历上拖动以创建事件。从场景菜单中选择'时间块'（仅在启用时间块时可见）。拖动以移动现有时间块。调整边缘以修改持续时间。",
			},
			performance: {
				header: "性能和行为",
		...
		defaults: {
			...
			basicDefaults: {
				...
				defaultContexts: {
					name: "默认场景",
					description: "默认场景的逗号分隔列表（例如，@家，@工作）",
					placeholder: "@家，@工作",
				},
				defaultTags: {
					name: "默认标签",
		...
		taskProperties: {
			...
			sections: {
				...
				dateProperties: "日期属性",
				datePropertiesDesc: "配置任务的到期日期和开始日期。",
				organizationProperties: "组织属性",
				organizationPropertiesDesc: "使用场景、项目和标签组织任务。",
				taskDetails: "任务详情",
			...
			properties: {
				...
				recurrence: {
					name: "重复",
					description:
						"重复任务的模式（每日、每周、每月、每年或自定义RRULE）。当重复任务完成时，其开始日期会自动更新到下一次出现。",
				},
				recurrenceAnchor: {
					name: "重复锚点",
					description:
						"控制下一次出现的计算方式：'scheduled'使用开始日期，'completion'使用实际完成日期。",
				},
				reminders: {
					name: "提醒",
					description:
						"在到期或开始日期前触发的通知。存储为带有时间和可选描述的提醒对象列表。",
				},
				title: {
					name: "标题",
					description:
		...
		appearance: {
			...
			defaultEventVisibility: {
				...
				showDueWhenScheduled: {
					name: "安排时显示到期日期",
					description: "即使对于已有开始日期的任务也显示到期日期",
				},
				showTimeEntries: {
					name: "显示时间条目",
		...
		integrations: {
			...
			googleCalendarExport: {
				...
				notices: {
					...
					notATask: "当前文件不是任务",
					noDateToSync: "任务没有可同步的开始日期或截止日期",
	...
	modals: {
		...
		scheduledDate: {
			...
			quickOptions: {
				today: "今天",
				todayAriaLabel: "将开始日期设为今天",
				tomorrow: "明天",
				tomorrowAriaLabel: "将开始日期设为明天",
				nextWeek: "下周",
				nextWeekAriaLabel: "将开始日期设为下周",
				now: "现在",
				nowAriaLabel: "将开始日期和时间设为现在",
				clear: "清除",
				clearAriaLabel: "清除开始日期",
			},
			errors: {
				invalidDateTime: "请输入有效的日期和时间格式",
				updateFailed: "更新开始日期失败。请重试。",
			},
		},
		timeEntryEditor: {
	...
	contextMenus: {
		task: {
			...
			notices: {
				...
				updateScheduledFailure: "更新任务开始日期失败：{message}",
	...
	services: {
		pomodoro: {
			notices: {
				...
				shortBreakStarted: "小憩已开始",
				longBreakStarted: "休整已开始",
				paused: "番茄钟已暂停",
				resumed: "番茄钟已恢复",
	...
	components: {
		...
		recurrenceContextMenu: {
			daily: "每日",
			weeklyOn: "每周{day}",
			everyTwoWeeksOn: "每2周的{day}",
			monthlyOnThe: "每月{ordinal}",
			everyThreeMonthsOnThe: "每3个月的{ordinal}",
