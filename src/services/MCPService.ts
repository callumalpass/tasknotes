	...
	private registerTaskTools(server: McpServer): void {
		...
		tool(
			...
			"Create a new task",
			{
				...
				attachments: z.array(z.string()).optional().describe("Vault-relative paths to attached files"),
		...
		tool(
			...
			"Update an existing task's properties",
			{
				...
				attachments: z.array(z.string()).nullable().optional().describe("New attached file paths or null to clear"),
