...
![Kanban board with task cards in status columns](../assets/screenshot-kanban.png)
...
![Kanban board showing status columns with task cards](../assets/screenshot-kanban.png)
