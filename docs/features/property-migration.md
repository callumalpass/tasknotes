...
![property migration automatic prompt flow](../assets/property-migration/property-migration-automatic-prompt-flow.gif)
...
![property migration command palette workflow](../assets/property-migration/property-migration-command-palette-workflow.gif)
