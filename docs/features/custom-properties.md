...
![Task edit modal with property fields](../assets/screenshot-task-edit-modal.png)
...
Not all chips are always visible. "This note" only appears when editing an existing task. "View items" only appears when the PropertyPicker was opened from a Bases view context (like bulk tasking).
...
![Task edit modal with custom property as date field](../assets/screenshot-task-edit-modal.png)
